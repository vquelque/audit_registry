      ...
      <form @submit.prevent="submit()">
        <div class="rounded-md shadow-sm -space-y-px">
          <div class="flex">
            ...
            <button
              type="submit"
              class="inline-flex items-center justify-center w-12 rounded-r-md border border-transparent text-sm font-medium text-white bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
            >
              <svg
